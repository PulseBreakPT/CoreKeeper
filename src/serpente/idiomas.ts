...
const pt: Textos = {
  ...
  escolherJogo: 'ESCOLHE O JOGO', tetrisNome: 'Blocos', tetrisDesc: 'Encaixa · limpa · domina', tetrisTitulo: 'Blocos perfeitos.<br><em>Decisões infinitas.</em>', jogarTetris: 'JOGAR BLOCOS',
  tetrisFrase: 'Sete peças. Dez colunas. Decisões infinitas.', tetrisPecas: 'Peças equilibradas', tetrisReserva: 'Reserva estratégica', tetrisProjecao: 'Projeção precisa',
  mazeNome: 'Labirinto', mazeDesc: 'Explora · engana · conquista', mazeTitulo: 'Um circuito vivo.<br><em>Quatro mentes à caça.</em>', jogarMaze: 'JOGAR LABIRINTO', mazeFrase: 'Recolhe a energia. Lê os sentinelas. Domina cada rota.', mazeIas: 'Personalidades próprias', mazePulso: 'Inverte a perseguição', mazeRotas: 'Labirinto original',
...
const en: Textos = {
  ...
  escolherJogo: 'CHOOSE A GAME', tetrisNome: 'Blocks', tetrisDesc: 'Fit · clear · master', tetrisTitulo: 'Perfect blocks.<br><em>Infinite decisions.</em>', jogarTetris: 'PLAY BLOCKS', tetrisFrase: 'Seven pieces. Ten columns. Infinite decisions.', tetrisPecas: 'Balanced pieces', tetrisReserva: 'Strategic reserve', tetrisProjecao: 'Precise projection',
  mazeNome: 'Maze', mazeDesc: 'Explore · outsmart · conquer', mazeTitulo: 'A living circuit.<br><em>Four minds on the hunt.</em>', jogarMaze: 'PLAY MAZE', mazeFrase: 'Collect energy. Read the sentinels. Master every route.', mazeIas: 'Unique personalities', mazePulso: 'Reverses the chase', mazeRotas: 'Original maze',
};
...
const es: Textos = {
  ...
  escolherJogo: 'ELIGE UN JUEGO', tetrisNome: 'Bloques', tetrisDesc: 'Encaja · limpia · domina', tetrisTitulo: 'Bloques perfectos.<br><em>Decisiones infinitas.</em>', jogarTetris: 'JUGAR BLOQUES', tetrisFrase: 'Siete piezas. Diez columnas. Decisiones infinitas.', tetrisPecas: 'Piezas equilibradas', tetrisReserva: 'Reserva estratégica', tetrisProjecao: 'Proyección precisa',
  mazeNome: 'Laberinto', mazeDesc: 'Explora · engaña · conquista', mazeTitulo: 'Un circuito vivo.<br><em>Cuatro mentes a la caza.</em>', jogarMaze: 'JUGAR LABERINTO', mazeFrase: 'Recoge energía. Lee a los centinelas. Domina cada ruta.', mazeIas: 'Personalidades propias', mazePulso: 'Invierte la persecución', mazeRotas: 'Laberinto original',
};
